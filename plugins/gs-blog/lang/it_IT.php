...
$i18n = array(
  ...
  'SETTINGS_RSS_DESC'         =>  'Scegli i settaggi per il RSS Auto-Importer. Auto-Importer pu&ograve; importare sia il contenuto completo dei feeds o un sommario con un link all&grave;articolo originario.', // Modified string in v3.4.1 ('Summary' changed to 'Excerpt') [not yet re-translated]
  'RSS_IMPORTER'              =>  'Abilita Auto-Importatore RSS',
  'RSS_CONTENT_DESCRIPTION'   =>  'Includa Contenuto o Sommario RSS', // Modified string in v3.4.1 ('Summary' changed to 'Excerpt') [not yet re-translated]
