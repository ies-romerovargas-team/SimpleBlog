...
function blog_display_posts() {
  ...
  GLOBAL $content, $blogSettings; // Declare GLOBAL variables
...
function show_blog_post($slug, $excerpt=false, $echo=true) {
  ...
  if (($excerpt == false) || (($excerpt == true) && ($blogSettings['postformat'] == 'Y')) || (strlen($post->content) <= $blogSettings['excerptlength'])) {
